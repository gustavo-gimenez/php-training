...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/hello')) {
            ...
            // info_demo_homepage
            if (preg_match('#^/hello/(?P<name>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'info_demo_homepage')), array (  '_controller' => 'Info\\DemoBundle\\Controller\\DefaultController::indexAction',));
            }
        ...
        // info_demo_add
        if ($pathinfo === '/record') {
            return array (  '_controller' => 'Info\\DemoBundle\\Controller\\DefaultController::recordAction',  '_route' => 'info_demo_add',);
        }
        ...
        if (0 === strpos($pathinfo, '/demo')) {
            ...
            // _demo_informatorio
            if ($pathinfo === '/demo/informatorio') {
                return array (  '_controller' => 'Acme\\DemoBundle\\Controller\\DemoController::informatorioAction',  '_route' => '_demo_informatorio',);
            }
